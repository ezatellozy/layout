...
$(function () {
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              feather.icons['menu'].toSvg({ class: 'font-small-4' }) +
              '</a>' +
        ...
        },
        {
          ...
          orderable: false,
           render:(data, type, full, meta)=>{
            ...
            return `<div class="form-check"><input type="checkbox"  class="form-check-input dt-checkboxes" name="id[${full['id']}]" value="${full['id']}"></div>`
           },
      ...
      dom:
        ...
        '<"col-sm-12 col-lg-8 ps-xl-75 ps-0"<"dt-action-buttons text-xl-end text-lg-start text-md-end text-start d-flex align-items-center justify-content-center align-items-center flex-sm-nowrap flex-wrap me-1"<"me-1"f>B>>' +
        '>t' +
      ...
      buttons: [
        {
          text: 'Add New User',
          className: 'add-new btn me-1 btn-primary mt-50',
          attr: {
        ...
        {
          text: 'Actions',
          className: 'delete btn btn-primary mt-50 d-none',
          attr: {
            'id' : 'remove-selected',
            'data-bs-toggle': 'modal',
  ...
  dtUserTable.on( 'change', 'input[type=checkbox]', function () {
    toggleSellection(this.value)
    
    let removeBtn = document.getElementById('remove-selected')
